...
pub struct VirtualMachine<'code, 'data> {
    ...
    host_functions: HashMap<String, ErasedFunction<'data>>,
...
impl<'code, 'data> VirtualMachine<'code, 'data> {
    ...
    pub fn with_host_function<A, R, N: Into<String>, F: Function<'data, A, R> + 'data>(
        mut self,
        name: N,
        func: F,
    ) -> Self {
    ...
    /// Execute a named bytecode function with arguments, returning the return value.
    ///
